    ...
    return (
      ...
      <Title style={styles.title}>{TITLE}</Title>
        <View style={{...style.itemContainer}}>
          <TextInputField name="name" binding={state} />
          <TextInputField name="tel" binding={state} />
          <TextInputField name="email" binding={state} />
          <TextInputField secureTextEntry name="password" binding={state} />
          <TextInputField
            secureTextEntry
            name="repeatPassword"
            binding={state}
        ...
        <View style={{...style.itemContainer, flexDirection: 'row', justifyContent: 'center', marginTop: 'auto'}}>

...
import { StyleSheet, TouchableHighlight, View, Text, Platform, Image as RNImage, ImageBackground as RNImageBackground, useEffect } from 'react-native';
...
export const Input = props => {
  ...
  return <React.Fragment>
    ...
    {...props}
    mode="flat"
    label={props.binding.label[props.name] + (props.required != null && props.binding.data[props.name] == null ? ' ' + props.required : '')}
    value={props.binding.data[props.name]}
    onChangeText={value => {props.binding.onChange(props.name, value)}}
    />
...
export const HeaderButton = (props) => {
  ...
  return (<Button
    ...
    color = {Colors.main}
    fontSize={20}
    buttonStyle={{borderBottomWidth: props.active ? 2 : 0, width: 30, height: 40, paddingBottom: 4, borderColor: 'white', borderRadius: 0, ...(props.buttonStyle || {}) }}
  ...
  render() {
    return (
      <Button
        ...
        {...this.props}
        buttonStyle={{ width: '100%', height: '100%', borderRadius: 0,...this.props.buttonStyle }}
        style={{
          margin: 0,
          borderWidth: 1,
          borderColor: '#1A3F5D',
...
export const OptionSelect = (props) => {
    ...
    <View style={{flex: 1, flexDirection: 'row', backgroundColor: '#E7E7E7', borderColor: '#ADADAD', borderBottomWidth: 1, height: 58, padding: 14, alignItems: 'center', justifyContent: 'space-between'}}>
